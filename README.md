...
found in [`docs/architecture.md`](docs/architecture.md).
...
[Get started with the Config API tutorial →](docs/tutorials/config_api/index.md)

### Creating a Model

A tutorial on how to create a simple predator-prey model can be found in the
[`docs/tutorials/`](docs/tutorials/) folder.
